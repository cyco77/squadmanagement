...
class accordionsquadcategorylisttemplate extends basesquadcategorylisttemplate
{
	public function renderTemplate()
	{
		$doc = JFactory::getDocument();

		$cssHTML = JURI::base().'components/com_squadmanagement/templates/squadcategorylist/Accordion/style.css';
