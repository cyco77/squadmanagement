...
class SquadManagementViewEditSquadMember extends JViewLegacy
{
	...
	function display($tpl = null) 
	{
		...
		$this->additionalFields = $model->getAdditionalFields();
		$this->assignRef('additionalFields',$this->additionalFields);
