...
class SquadManagementViewSquads extends JViewLegacy
{
	...
	{
		JToolBarHelper::title(JText::_('COM_SQUADMANAGEMENT_MANAGER_SQUADS'),'squads');
		...
		{	
			JToolBarHelper::divider();
			JToolBarHelper::deleteList('', 'squads.delete');
		}		
	...
	{
		return array(
			'a.name' => JText::_('COM_SQUADMANAGEMENT_SQUAD_HEADING_NAME'),
			'a.shortname' => JText::_('COM_SQUADMANAGEMENT_SQUAD_HEADING_SHORTNAME'),
			'category' => JText::_('COM_SQUADMANAGEMENT_SQUAD_HEADING_CATEGORY'),
			);
	}
}
