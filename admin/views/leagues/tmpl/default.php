...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_squadmanagement&task=leagues.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_squadmanagement&view=leagues'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				...
				<th style="text-align:left;width:60%">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_LEAGUE_HEADING_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>		
				<th style="text-align:left" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_LEAGUE_HEADING_SHORTNAME', 'a.shortname', $listDirn, $listOrder); ?>
				</th>		
				<th style="text-align:left;width:30%" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_LEAGUE_HEADING_URL', 'a.url', $listDirn, $listOrder); ?>
				</th>	
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="nowrap">
					<a href="<?php echo JRoute::_('index.php?option=com_squadmanagement&task=league.edit&id=' . $item->id); ?>">
						<?php echo $item->name; ?>
					</a>
				</td>
