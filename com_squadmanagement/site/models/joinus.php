...
class SquadManagementModelJoinUs extends JModelForm
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_squadmanagement.joinus', 'joinus', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	{
		$data = (array)JFactory::getApplication()->getUserState('com_squadmanagement.joinus.data', array());
		return $data;
	}
	...
	{		
		...
		$enableforummessage = $params->get('enablejoinuskunenaforummessage','1');
		if ($enableforummessage == 1)
		{
			SquadmanagementHelper::sendJoinUsKunenaPost($joinus,$params);
		}
