...
class blocksadvancedsquadcategorylisttemplate extends basesquadcategorylisttemplate
{
	public function renderTemplate()
	{
		$doc = JFactory::getDocument();

		$cssHTML = JURI::base().'components/com_squadmanagement/templates/squadcategorylist/BlocksAdvanced/style.css';
