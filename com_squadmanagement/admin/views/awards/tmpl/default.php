...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_squadmanagement&task=awards.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_squadmanagement&view=awards'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>				
				...
				<th style="text-align:left">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_AWARD_HEADING_AWARDDATE', 'a.awarddate', $listDirn, $listOrder); ?>
				</th>		
				<th></th>
				<th style="text-align:left;width:30%">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_AWARD_HEADING_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>		
				<th style="text-align:left;width:30%" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_AWARD_HEADING_SQUAD', 's.name', $listDirn, $listOrder); ?>
				</th>	
				<th style="text-align:left;width:10%" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_AWARD_HEADING_PLACE', 'a.place', $listDirn, $listOrder); ?>
				</th>	
				<th style="text-align:left;width:30%" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_SQUADMANAGEMENT_AWARD_HEADING_URL', 'a.url', $listDirn, $listOrder); ?>
				</th>	
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="nowrap" >
					<?php echo JHtml::_('date', $item->awarddate, JText::_('DATE_FORMAT_LC1')); ?>
				</td>			
				<td class="nowrap" style="text-align:center;">
				<?php
				if ($item->imageurl != '')
				{
					echo '<img src="'.JURI::root().$item->imageurl.'" alt="' . $item->name . '" style="height:20px;width:20px;max-width: none;"/>'; 	
				}
				else
				{
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_squadmanagement&task=award.edit&id=' . $item->id); ?>">
						<?php echo $item->name; ?>
					</a>
				</td>
